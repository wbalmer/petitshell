...
# general setup
retrieval_name = 'AFLepb_shell_ln-amorphous-onefsed-dbptgrads'
# retrieval_name = 'AFLepb_shell_ln-crystalline-onefsed'
...
if __name__ == '__main__':
    ...
    cloud_species = ['Na2S(s)_crystalline__DHS',
    ...
    if rank==0:
        ...
        if plot:
            ...
            plt.plot(allw, allf, label='log Z: {:.2f}'.format(sampler.log_z), color='red')
            plt.errorbar(test_w[2], pfs, yerr=pfes, marker='o', color='k', label='photometry')
